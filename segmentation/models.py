...
#     def configure_callbacks(self):
#         # Define the ModelCheckpoint callback to save the best model based on validation IoU
#         checkpoint_callback = ModelCheckpoint(
#             monitor='val_iou',  # Monitor validation IoU
#             mode='max',  # Maximize the monitored metric (IoU)
#             dirpath='./saved_models/',  # Directory to save the checkpoints
#             filename=
#             'best_model_{val_iou:.4f}',  # Use IoU value in the checkpoint filename
